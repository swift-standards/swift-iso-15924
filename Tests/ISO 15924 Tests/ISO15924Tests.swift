...
struct ISO15924Tests {
    ...
    struct Unit {
        ...
        func `Numeric: Common static constants`() {
            #expect(ISO_15924.Numeric.`215`.value == "215")
            #expect(ISO_15924.Numeric.`220`.value == "220")
            #expect(ISO_15924.Numeric.`160`.value == "160")
            #expect(ISO_15924.Numeric.`501`.value == "501")
            #expect(ISO_15924.Numeric.`502`.value == "502")
            #expect(ISO_15924.Numeric.`125`.value == "125")
            #expect(ISO_15924.Numeric.`315`.value == "315")
            #expect(ISO_15924.Numeric.`413`.value == "413")
        }
